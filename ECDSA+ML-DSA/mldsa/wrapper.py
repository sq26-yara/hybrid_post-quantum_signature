...
class MLDSA44:
    ...
    def generate_keypair(self) -> Tuple[bytes, bytes]:
        ...
        print(f"     Час генерації ключів ML-DSA-44: {keygen_time*1000:.2f} мсек")
    ...
    def sign(self, data: bytes, private_key: bytes) -> bytes:
        ...
        print(f"     Час підпису за допомогою ML-DSA-44: {sign_time*1000:.2f} мсек")
    ...
    def verify(self, data: bytes, signature: bytes, public_key: bytes) -> bool:
        ...
        try:
            with oqs.Signature(self.ALGORITHM) as verifier:
                ...
                print(f"     Час перевірки підпису ML-DSA-44: {verify_time*1000:.2f} мсек")
            return is_valid
        except Exception:
            return False
